...
ActiveRecord::Schema.define(:version => 20130519114924) do
  ...
  add_index "administrator_sessions", ["administrator_id"], :name => "index_administrator_sessions_on_administrator_id"
